...
def train(flags):  # pylint: disable=too-many-branches, too-many-statements
    ...
    model = Net(env.observation_space.shape, env.action_space.n, flags.use_lstm, flags.deep)
    ...
    learner_model = Net(
        env.observation_space.shape, env.action_space.n, flags.use_lstm, flags.deep,
...
class DeepAtariNet(nn.Module):
    def __init__(self, num_actions, use_lstm=False):
        super(DeepAtariNet, self).__init__()
        self.num_actions = num_actions
        self.use_lstm = use_lstm
...
def Net(observation_shape, num_actions, use_lstm, deep):
    if not deep:
        return AtariNet(observation_shape, num_actions, use_lstm)
    else:
        return DeepAtariNet(num_actions, use_lstm)
